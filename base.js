...
function http_call(url, body, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        function call_without_timeout() {
            return __awaiter(this, void 0, void 0, function () {
                var fetch_1, url_with_params, method, result, e_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            url_with_params = options.params ? build_url(url, options.params) : url;
                            method = options.method ? options.method : 'post';
                            return [4 /*yield*/, fetch_1(url_with_params, {
                                    method: method,
...
exports.group_by_n = group_by_n;
exports.test("group_by_n", function () {
    exports.assert.equal(group_by_n([1, 2, 3], 2), [[1, 2], [3]]);
    exports.assert.equal(group_by_n([1, 2], 2), [[1, 2]]);
    exports.assert.equal(group_by_n([1], 2), [[1]]);
    exports.assert.equal(group_by_n([], 2), []);
});
// execute_async -----------------------------------------------------------------------------------
function execute_async(tasks, process, workers_count) {
    return __awaiter(this, void 0, void 0, function () {
        function worker() {
            return __awaiter(this, void 0, void 0, function () {
                var task_i, task, _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
        ...
        var results, i, promises, i_1, promises_1, promises_1_1, promise, e_5_1;
        var e_5, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    i = 0;
                    promises = [];
                    for (i_1 = 0; i_1 < workers_count; i_1++)
                ...
                case 7:
                    ...
                    return [7 /*endfinally*/];
                case 8: return [2 /*return*/, map(tasks, function (_v, i) { return results[i]; })];
            }
        });
    });
}
