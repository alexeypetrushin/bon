...
export declare function http_call<In, Out>(url: string, body?: In | {}, options?: HttpCallOptions): Promise<Out>;
...
export declare function last<T>(list: string): T[];
export declare function last<T>(list: string, n: number): T[];
...
export { group_by };
export declare function group_by_n<V>(list: V[], n: number): V[][];
export declare function execute_async<T, R>(tasks: T[], process: ((task: T) => Promise<R>), workers_count: number): Promise<R[]>;
